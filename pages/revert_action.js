...
const RevertAction = () => (
  <Page>
    <Heading>You created a new page called RevertAction</Heading>
    <p>You can visit this page by appending "/RevertAction" to your URL</p>
    <p>You can edit this page in "/pages/revert_action</p>
